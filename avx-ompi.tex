...
\todo{what exactly is this? there are sentences in the middle that just dont make sense there}
...
Our optimization using intrinsic, which gives us complete control of the low-level details at the expense of productivity and portability. \todo{what low-level details we control?}
...
Moreover, for the gather pack case, the reduction is gradual.\todo{by here you lost me for good}
